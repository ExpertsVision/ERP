          ...
          <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form action="leave_application_submitted" method="post" id="leave_application_submitted">
                        @csrf
                        ...
                        <div class="demo-masked-input">
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <div class="form-line">
                                                <input type="text" name="datefrom" class="form-control date" placeholder="Date From Ex: 30-07-2016" required="">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <div class="form-line">
                                                <input type="text" name="dateto" class="form-control date" placeholder="Date To Ex: 30-07-2016" required="">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
