...
<body class="login-page">
    <div class="login-box">
        <div class="card">
            <div class="body">
              <form id="form_advanced_validation" role="form" method="POST" action="{{ route('login') }}">
                @csrf
                  <div class="logo">
                     <center> <img src="images/logo.png" class="img-responsive" alt="Cinque Terre" width="170" height="170"> </center>   
                      </div>
