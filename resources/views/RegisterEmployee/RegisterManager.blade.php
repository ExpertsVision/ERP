                    ...
                    <div class="card">
                        ...
                        @csrf
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="name" value="{{ old('company_name') }}" required/>
                                ...
                                <div class="form-group form-float">
                                    <div>
                                    <p style="color: #C0C0C0; font-family: arial; font-weight: lighter;">
                                        <b>Role</b>
                                    </p>
                                    </div>
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <select class="form-control show-tick" tabindex="-98" name="department_id">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <select class="form-control show-tick" tabindex="-98" name="timezone">
